...
const PUBLIC_APP_ROUTES = ["/onboarding", "/images", "/api/health"];
export default auth((req) => {
    ...
    // Allow users to reach /onboarding without being logged in (Guest Welcome/Register)
    ...
    // Authenticated User on Auth Page Handling (Redirect to Dashboard)
